        ...
        <div className="footer-brand-column">
          ...
          <div className="footer-contact-stack">
            <div className="footer-socials">
              ...
              <a className="footer-social footer-mail" href={`mailto:${SITE_EMAIL}`} aria-label={`${fr ? "Envoyer un e-mail à" : "Send an email to"} ${SITE_EMAIL}`} title={SITE_EMAIL}>
                <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.5 6.75A2.25 2.25 0 0 1 5.75 4.5h12.5a2.25 2.25 0 0 1 2.25 2.25v10.5a2.25 2.25 0 0 1-2.25 2.25H5.75a2.25 2.25 0 0 1-2.25-2.25V6.75Z"/><path d="m4.3 6 6.28 5.02a2.25 2.25 0 0 0 2.84 0L19.7 6"/></svg>
              </a>
            </div>
          </div>
        </div>
